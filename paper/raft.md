...
​	Raft 将任期划分为任意长度，如本文图 5 所示。为每个任期分配一个连续的整数。如本文第5.2节所述，每个任期都以选举开始，过程中一名或多名候选者试图成为领导者。如果候选者赢得选举，它将担任整个任期的领导者。在某些情况下，选举可能会因分裂投票没有选出领导者。在这种情况下，任期结束时没有领导者，将快速再次选举以开始新的任期。Raft保证任何任期内最多有一个领导者。
